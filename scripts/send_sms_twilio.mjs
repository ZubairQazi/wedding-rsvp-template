...
function buildMessage(row) {
  ...
  return (
    `Together with their families, Partner One and Partner Two request the pleasure of your company at their wedding celebration.\n\n` +
    `Lakeside, USA\n\n` +
    `Please RSVP by August 1. (RSVP Code: ${token})\n` +
